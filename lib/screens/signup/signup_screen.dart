          ...
          builder: (context, snapshot) {
            return ListView(
              ...
              children: <Widget>[
                const FieldTitle(
                  title: 'Apodo',
                  subtitle: 'Cómo aparecerá en sus anuncios.',
                ),
                TextFormField(
                  decoration: const InputDecoration(
                    border: OutlineInputBorder(),
                    hintText: 'Por ejemplo: juan s.',
                  ),
                  validator: (text){
                    if(text.length < 6)
                      return 'Apodo demasiado corto';
                    return null;
                  },
                ...
                const FieldTitle(
                  title: 'E-mail',
                  subtitle: 'Le enviaremos un correo de confirmación.',
                ),
                TextFormField(
                  decoration: const InputDecoration(
                    border: OutlineInputBorder(),
                ...
                const FieldTitle(
                  title: 'Contraseña',
                  subtitle: 'Use letras, números y caracteres esp.',
                ),
                PasswordField(
